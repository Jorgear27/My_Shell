...
void test_is_monitor_command(void)
{
    char* valid_commands[][2] = {{"start_monitor", NULL},        {"stop_monitor", NULL}, {"status_monitor", NULL},
                                 {"update_config", "key value"}, {"show_config", NULL},  {NULL, NULL}};

    char* invalid_commands[][2] = {{"invalid_command", NULL}, {"echo", "Hello, World!"}, {"cd", "/home"}, {NULL, NULL}};
