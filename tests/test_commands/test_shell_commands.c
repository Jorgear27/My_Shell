...
void test_show_help(void)
{
    ...
    const char* expected_output = "Available commands:\n"
                                  ...
                                  "  search <dir> <ext> - Searches for files with a specific extension in "
                                  "a directory\n"
                                  ...
                                  "  show_config       - Shows the current configuration of the monitoring "
                                  "program\n"
                                  "  update_config <key> <value> - Updates the configuration of the "
                                  "monitoring program\n";
...
void test_quit_shell(void)
{
    ...
    else if (pid == 0)
    {
        // Child process
        quit_shell();
        // If quit_shell() works correctly, the following line should not be
        // executed
