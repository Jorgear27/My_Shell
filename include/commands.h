...
/**
 * @brief Searches for files with a specific extension in a directory.
 *
 * @param dir_path Directory path to search for files.
 * @param file_extension .json, .txt, etc.
 * @param printed 1 if the function has already printed the header, 0 otherwise.
 */
